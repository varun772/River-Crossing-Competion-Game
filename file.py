...
def player_score(score12):
    score12_val = v_font.render('score of player2: ' + str(score12),
                                True, (200, 120, 0))
    screen.blit(score12_val, (200, 300))


def player1_score1(score13):
    score13_val = v_font.render('score of player1:' + str(score13),
                                True, (100, 140, 123))
        ...
        if mykran % 2 == 0:
            ...
            for i in range(num_of_enemies):
                ...
                if scorec > 0:
                    ...
                    b = 1
            for i in range(num_of_enemies):
                collision = iscollision(enemy1X[i], enemy1Y[i],
                        playerX, playerY)
                if collision:
                    scorec += 1
                if scorec > 0:
            ...
            for i in range(num_of_enemies):
                collision = iscollision(enemyX[i], enemyY[i], player1X,
                        player1Y)
                if collision:
                    scorec += 1
                    mykran = 0
